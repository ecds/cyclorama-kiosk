define('ember-leaflet/components/popup-layer', ['exports', 'ember-leaflet/components/div-overlay-layer'], function (exports, _divOverlayLayer) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _divOverlayLayer.default.extend({
    ...
    popupOpenDidChange: Ember.observer('popupOpen', function () {
    ...
    _onLayerRemove({ layer }) {
      if (layer === this._layer) {
        if (this.get('parentComponent')._layer._map._fadeAnimated) {
          this._destroyAfterAnimation = Ember.run.later(() => {
    ...
    _addPopupListeners() {
      ...
      this._layer.onAdd = map => {
        ...
        Ember.run.cancel(this._destroyAfterAnimation);
