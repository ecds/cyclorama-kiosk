define('ember-leaflet/components/tooltip-layer', ['exports', 'ember-leaflet/components/div-overlay-layer'], function (exports, _divOverlayLayer) {
  'use strict';
  ...
  exports.default = _divOverlayLayer.default.extend({
    ...
    shouldRender: Ember.computed.reads('permanent'),
